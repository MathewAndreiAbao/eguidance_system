...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <form method="GET" action="<?= site_url('appointments') ?>" class="bg-white shadow rounded-lg p-4 mb-6">
        ...
        <div class="mt-4 flex items-center space-x-3">
            ...
            <a href="<?= site_url('appointments') ?>" class="text-sm text-gray-600 hover:text-gray-900">Reset filters</a>
        </div>
    </form>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                ...
                <?php endif; ?>
                <?php if ($session && ($session->userdata('role') == 'counselor' || $session->userdata('role') == 'admin')): ?>
                        ...
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <?php endif; ?>
                                    <p class="text-sm text-gray-700 mt-1"><?= html_escape($appointment['counselor_name'] ?? '—') ?></p>
                            ...
                            <div class="mt-4 flex items-center space-x-2">
                                ...
                                <?php elseif ($session && ($session->userdata('role') == 'admin' || $session->userdata('role') == 'counselor')): ?>
