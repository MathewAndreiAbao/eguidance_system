...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <form method="GET" action="<?= site_url('appointments/counselor_dashboard') ?>" class="bg-white shadow rounded-lg p-4 mb-6">
        ...
        <div class="mt-4 flex items-center space-x-3">
            ...
            <a href="<?= site_url('appointments/counselor_dashboard') ?>" class="text-sm text-gray-600 hover:text-gray-900">Reset filters</a>
        </div>
    </form>

    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
            <h2 class="text-lg font-medium text-gray-900">Student Appointments</h2>
            <div class="flex space-x-2">
                <a href="<?= site_url('appointments/counselor_dashboard') ?>" class="bg-primary hover:bg-secondary text-white font-bold py-2 px-4 rounded">
                    Refresh
                </a>
            </div>
        </div>
