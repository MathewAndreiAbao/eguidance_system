...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <form method="POST" action="<?= site_url('career-guidance/edit-scholarship/' . $scholarship['id']) ?>">
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-2">Title *</label>
                <input type="text" name="title" required value="<?= htmlspecialchars($scholarship['title']) ?>"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="provider" required value="<?= htmlspecialchars($scholarship['provider']) ?>"
                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="4"
                          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                          placeholder="Provide a detailed description of this scholarship..."><?= htmlspecialchars($scholarship['description'] ?? '') ?></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="eligibility_criteria" rows="3"
                          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                          placeholder="List the eligibility requirements for this scholarship..."><?= htmlspecialchars($scholarship['eligibility_criteria'] ?? '') ?></textarea>
            </div>

            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-2">Application Deadline</label>
                <input type="date" name="application_deadline" value="<?= htmlspecialchars($scholarship['application_deadline'] ?? '') ?>"
                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>

            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-2">Award Amount</label>
                <input type="text" name="award_amount" value="<?= htmlspecialchars($scholarship['award_amount'] ?? '') ?>"
                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            ...
            <div class="mb-6">
                ...
                <input type="url" name="application_link" value="<?= htmlspecialchars($scholarship['application_link'] ?? '') ?>"
                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
